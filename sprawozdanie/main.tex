...
\section{Dodatek}
MS Teams lubi bardzo zmieniać nazwy plików co może powodować problemy z
kompilacją. Poniżej podaję oryginalne nazwy plików źródłowych:
\begin{itemize}
	\item 343333.c
	\item adjacency\_matrix.c
	\item incidence\_matrix.c
	\item adjacency\_list.c
	\item adjacency\_matrix.h
	\item incidence\_matrix.h
	\item adjacency\_list.h
	\item Makefile
\end{itemize}
Kod źródłowy jest również dostępny na moim GitHubie pod adresem:
\url{https://github.com/DoggoGood/pi_miniproj3}
