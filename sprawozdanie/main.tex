...
które jeszcze nie miały połączenia. Gdy mamy każdy wierzchołek dostał
połączenie z innym wierzchołki, mamy gotowe minimalne drzewo rozpinające.
...
Na początku sprwadzamy czy podana liczba krawędzi jest wystarczająca do utworzenia
spójnego grafu. Następnie w zależności od podanej metody wywołujemy odpowiednią
funkcję tworzącą graf.
...
Program jest kompilowany za pomocy GNU make. Aby skompilować program, należy
